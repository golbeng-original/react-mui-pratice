import { AppBar, Box, Button, Container, Divider, Drawer, IconButton, MenuItem, PaletteMode, SvgIcon, Toolbar } from "@mui/material"
...
const ToggleColorMode = (props:{mode?:PaletteMode, toggleColorMode?:()=>void}) => {
    return (
        <IconButton
...
const AppBarMenuDrawerXs = (props:AppBarMenuProps) => {
    ...
    const handleScrollToSection = (sectionId:string) => {
        ...
        if( props.scrollToSection(sectionId) === false) {
            return
        }
    ...
    return (
        <>
            ...
            >
                <IconButton aria-label='Menu button' onClick={handleToggleButton(true)}>
                    <MenuIcon />
                </IconButton>
                <Drawer anchor='top' open={open} onClose={handleToggleButton(false)}>
                    <Box
                        sx={{
                            p: 2,
                    ...
                    >
                        ...
                        >
                            ...
                            <IconButton onClick={handleToggleButton(false)}>
                                <CloseRoundedIcon />
                            </IconButton>
                        </Box>
                        <Divider sx={{my:3}}/>
...
const AppBarMenuMd = (props:AppBarMenuProps) => {
    return (
        <>
            <Box 
                sx={{
            ...
            >
                ...
                >
                    ...
                    <Button
                        ...
                        color='info'
                        size='small'
                        onClick={() => {props.scrollToSection('testimonials')}}
                    >
                        Testimonials
                    </Button>
                    <Button
                        ...
                        color='info'
                        size='small'
                        onClick={() => {props.scrollToSection('highlights')}}
                    >
                        Highlights
                    </Button>
                    <Button
                    ...
                    <Button
                        ...
                        color='info'
                        size='small'
                        onClick={() => {props.scrollToSection('faq')}}
                    >
                        FAQ
                    </Button>
                </Box>
...
export const AppAppBar = (props:AppAppBarProps) => {
    ...
    const scorllToSection = (sectionId:string) => {
            ...
            <Container maxWidth='lg'>
                ...
                >
                    ...
                    <AppBarMenuMd 
                        ...
                        scrollToSection={scorllToSection}
                    />
                    <AppBarMenuDrawerXs 
                        mode={mode}
                        toggleColorMode={toggleColorMode}
