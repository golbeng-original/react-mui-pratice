                    ...
                    sx={(theme) => ({
                      ...
                      ...(tier.title === 'Professional' && {
                        ...
                        boxShadow: theme.palette.mode === 'light'
                          ? '0 8px 12px hsla(210, 89%, 42%, 0.2f)'
                          : '0 8px 12px hsla(0, 0%, 0%, 0.0f)',
                        background: 'radial-gradient(circle at 50% 0%, hsl(201, 90%, 35%), hsl(210, 100%, 16%))'
                      })
                    })}
                  >
                    <CardContent>
                      ...
                      >
                        ...
                        {tier.title === 'Professional' && (
                          <Chip
                            ...
                            size='small'
                            sx={{
                              borderColor: 'hsla(200, 60%, 99%, 0.3)',
